...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      this.Color = com.pluralsight.kafka.model.Color.values()[in.readEnum()];

      this.ProductType = com.pluralsight.kafka.model.ProductType.values()[in.readEnum()];

      this.DesignType = com.pluralsight.kafka.model.DesignType.values()[in.readEnum()];
